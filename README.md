...
> - **Preloads stay on the primary source** and retry on a back-off if it cannot be dialed at startup, so a warm placeholder source never captures them; ordinary viewers still get the placeholder while a camera is off or briefly rate limited.
